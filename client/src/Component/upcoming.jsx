                        ...
                        <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                            <Slider>
                                <div id="slider" className="h-80 flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                                    <Slide index={0}>
                                            <img src={img1} alt="black chair and white table" className="object-cover object-center w-80 h-80" />
                                    </Slide>
                                    <Slide index={1}>
                                        <img src={img2} alt="sitting area" className="object-cover object-center w-80 h-80" />
                                    </Slide>
                                    <Slide index={2}>
                                        <img src={img3} alt="sitting area" className="object-cover object-center w-80 h-80" />
                                    </Slide>
                                    <Slide index={3}>
                                        <img src={img4} alt="sitting area" className="object-cover object-center w-80 h-80" />
                                    </Slide>
                                    <Slide index={4}>
                                        <img src={img5} alt="black chair and white table" className="object-cover object-center w-80 h-80" />    
                                    </Slide>   
                                </div>
                            </Slider>
                        </div>
